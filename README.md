...
**hoko(yari)** is a chat bot built on the [Hubot][hubot] framework. It was
...
### Running `hoko` Locally

You can test your hubot by running the following, however some plugins will not
behave as expected unless the [environment variables](#configuration) they rely
upon have been set.

You can start hoko locally by running:
...
Then you can interact with hoko by typing `hoko help`.

    hoko> hoko help
    hoko animate me <query> - The same thing as `image me`, except adds [snip]
    hoko help - Displays all of the help commands that hoko-yaribot knows about.
    ...
